...
public class AddTaskViewController implements ViewController
{
  ...
  @FXML public Label errorDeadlineMessage;
  @FXML public ImageView avatarPic;
  @FXML public Label errorPriorityMessage;
  ...
  @FXML public TableView<WorkersWithCheckboxTable> workersTable;
  @FXML public TableColumn<WorkersWithCheckboxTable, String> numberColumn;
  @FXML public TableColumn<WorkersWithCheckboxTable, String> nameColumn;
